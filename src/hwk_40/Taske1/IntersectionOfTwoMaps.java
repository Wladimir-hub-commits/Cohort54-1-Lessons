...
/**
 * Author Waldemar Ilz
 * {code data} 23.02.2025
 */

/*
Task 1
Пересечение двух карт:
Реализуйте метод, который принимает две карты Map<String, Integer> и возвращает
новую карту, содержащую только те записи, ключи которых присутствуют в обеих
исходных картах.
...
public class IntersectionOfTwoMaps {
    ...
    public static Map<String, Integer> intersection(Map<String, Integer> map1, Map<String, Integer> map2) {
        ...
        for (String key : map1.keySet()) {
            if (map2.containsKey(key)) {
                // Добавляем запись в новую карту, значение можно брать из любой карты
